...
const App: React.FC = () => {
  ...
  const FileUrl =
    "https://docs.google.com/document/d/1aQwSdBPbMyvyL6wF4sI6zgu16vu4bDYBcRXNVFO-KDY/edit?usp=sharing";
    ...
    <div>
      ...
      <div className="container text-center">
        ...
        <p className="openingP border border-dark">
          Hello! My name is Trung, and I am a first-generation Vietnamese
          student in my senior year Computer Science at Iowa State University.
          I'm seeking an internship to enhance my skills in mobile/web app
          development and broader computer science roles.
          <br></br>
          <br></br>
        ...
        {ShowContactForm && <ContactForm {...mockData} onClose={toggleForm} />}
      </div>
    </div>
  );
};
